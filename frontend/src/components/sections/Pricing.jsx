...
/**
 * PRICING
 * Uses: Neon Gradient Card (recommended plan), Rainbow Button, Number Ticker, Border Beam.
...
export function Pricing() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[520px] bg-[radial-gradient(1000px_400px_at_50%_-10%,rgba(124,58,237,0.20),transparent_60%)]"
      />
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 relative">
            {/* Best value tag (typography-only, not a pill badge) */}
            ...
            <NeonGradientCard borderSize={2} borderRadius={22}>
              <div className="p-6 sm:p-9">
                <div className="flex flex-wrap items-start justify-between gap-6">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground max-w-md">
                      Everything a modern D2C brand needs to ship a world-class
                      checkout in India.
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="text-5xl sm:text-6xl font-semibold tracking-tighter text-brand">
                      <NumberTicker
                        value={0.5}
                        decimalPlaces={1}
                        suffix="%"
                ...
                <ul className="mt-7 grid gap-3 sm:grid-cols-2">
                  ...
                  <PriceLine>
                    COD Verification:{" "}
                    <span className="rounded-md bg-success/10 px-1.5 py-0.5 font-bold text-success">
                      FREE
                    </span>{" "}
                    <span className="font-semibold text-ink dark:text-white">
                      Forever
                ...
                <div className="mt-8 flex flex-wrap items-center justify-between gap-6">
                  <p className="text-base font-medium text-ink dark:text-white">
                    ...
                    <span className="text-muted-foreground">→</span> Higher
                    Conversions.
                  </p>
                  <RainbowButton
                    as="button"
          ...
          <BlurFade delay={0.15}>
            <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-border bg-card p-6 sm:p-7">
              <BorderBeam size={180} duration={14} colorFrom="#7C3AED" colorTo="#22D3EE" />
              <h3 className="text-2xl font-semibold tracking-tight text-ink dark:text-white">
                Enterprise
              </h3>
