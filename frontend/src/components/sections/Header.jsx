...
/**
 * Sticky header + inline anchor navigation.
 * Uses: Magic UI Interactive Hover Button, Theme Toggle.
 * (Scroll Progress bar is mounted at page level.)
 */
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-brand to-brand-deep text-white shadow-sm">
