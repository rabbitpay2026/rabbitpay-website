...
import { ShoppingBag, Zap, CheckCircle2, QrCode, Landmark, Wallet } from "lucide-react";
...
export function HowItWorks() {
  ...
  return (
    <section
      ...
      className="relative border-t border-border bg-secondary/30 py-20 md:py-24"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <BlurFade>
          ...
          <h2 className="mt-3 max-w-3xl text-3xl font-semibold leading-[1.05] tracking-tighter text-ink dark:text-white sm:text-4xl md:text-5xl">
            From "Add to cart" to "Order placed" - in three seconds.
          </h2>
        ...
        <BlurFade delay={0.15}>
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              <BeamNode
                ref={doneRef}
                className="border-brand-accent/40 bg-brand-accent text-white shadow-lg shadow-brand-accent/30"
              >
