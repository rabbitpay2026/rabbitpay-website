...
const PARTNERS = [
  ...
  { name: "Cashfree", file: "wm-cashfree.png" },
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <BlurFade delay={0.12}>
          <div className="mt-11 flex flex-wrap items-center justify-center gap-x-12 gap-y-10 sm:gap-x-16">
            {PARTNERS.map((partner) => (
              <span
                key={partner.name}
                className="flex h-8 items-center justify-center gap-2.5 opacity-90 transition-opacity duration-300 hover:opacity-100 sm:h-10"
              >
                <img
