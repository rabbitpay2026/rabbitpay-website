      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14">
          <BentoGrid className="auto-rows-[minmax(220px,auto)]">
            <BentoCard colSpan="md:col-span-4" rowSpan="md:row-span-2" className="min-h-[420px]">
              <BorderBeam size={260} duration={10} colorFrom="#196BF5" colorTo="#4A8CFA" />
              <div className="flex flex-1 flex-col justify-between p-6 md:p-8">
                <div>
                  ...
                  <p className="mt-2 max-w-md text-sm text-muted-foreground">
                    Track every checkout signal from OTP to prepaid capture with a merchant dashboard
                    that behaves like production, not a demo.
                  </p>
                </div>
                <div className="mt-8">
                  <AnimatedList
                    ...
                    visibleCount={4}
                    renderItem={(item) => (
                      <div className="flex items-center gap-3 rounded-xl border border-border bg-background/80 p-3 backdrop-blur dark:bg-white/[0.02]">
    ...
    <BentoCard colSpan={colSpan} className="min-h-[220px]">
      <MagicCard className="h-full rounded-3xl border-0 bg-transparent">
        <div className="relative flex h-full flex-col justify-between p-6 md:p-7">
          <div
            aria-hidden="true"
            className={cn("pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b opacity-70", accent)}
          />
